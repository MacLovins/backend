...
сила вопроса    s_q = 1 − Π(1 − v_e)                       # noisy-OR: независимые подтверждения усиливают
Intent (0–100)  = 100 × (1 − exp(−Σ_{q+} w_q·s_q / τ))     # насыщение: 1–2 сильных сигнала уже много
Risk   (0–100)  = 100 × (1 − exp(−Σ_{q−} w_q·s_q / τ_neg))
Fit    (0–100)  = must-have ? 20 + 80 × Σ(вес совпавших nice-to-have) / Σ(весов) : 0   # 0 = вне ICP (флаг outside_icp)
Priority        = 100 × (Fit/100)^0.4 × (Intent/100)^0.6 × (1 − 0.5·Risk/100)   # нужны и Fit, и Intent
Tier            = disqualified (правило) | hot ≥ 65 | warm ≥ 40 | cold
```

Значения по умолчанию лежат в профиле скоринга и меняются в UI: веса H/M/L = 3/2/1; сила weak/moderate/strong =
0.35/0.65/1.0; τ = 5, τ_neg = 2 (при τ = 3 Intent насыщался и смена веса вопроса не меняла tier); полураспад: jobs 45 дн., news 120, website 240, report 365, incident 270.
