...
# Industry ids of the parser taxonomy → NIS2 annex (I: sectors of high criticality, II: other critical sectors)
    ...
    if finance:
        out.append(
            _signal(
                ...
                summary="In DORA scope: EU financial entity subject to the Digital Operational Resilience Act.",
            )
        )
    return out
